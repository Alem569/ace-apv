...
4. Het praten over hiding methodes of het helpen van mensen om die methodes aan te leren kan ook resulteren in een ban.
5. Het lid zijn van een cheating discord/community is ook niet toegestaan.
6. Mochten wij erachter komen dat mensen op de hoogte waren van een cheating door een bepaald groepje, zouden wij mogen bepalen om iedereen als medeplichtig te bannen.
...
Het gebruik maken van exploits wordt niet geaccepteerd, mocht jij er één of meerdere vinden? Meld ze dan in een ticket! Als je ze niet meldt en wij komen er achter, kan je hiervoor afhankelijk van de ernst van de zaak een straf krijgen.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot
    * Het aannemen van goederen van iemand die stopt.
    * Het aannemen van geld van een random iemand.
...
### Artikel 2.1: FailRP
Het is niet toegestaan om opzettelijk een roleplay van slechte kwaliteit uit te spelen. 
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Het leksteken van een band mag alleen als je in een actief scenario met diegene bent. Ga je hier verkeerd mee om? Een stafflid kan besluiten om je mes in te nemen.
    * Het is niet toegestaan om kleding te dragen van overheidsjobs.
...
Het is niet toegestaan om opzettelijk de roleplay op een oneerlijke of onrealistische manier te vormen, bijvoorbeeld door de verhaallijn op een onnatuurlijke manier te veranderen of door onrealistische dwang uit te oefenen op de andere partij.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * geven van een ‘’vergeet spuit’’ bestaat niet. Je kan wel drank geven, dat iemand iets voor de komende 15 minuten vergeet. Daarna mag die persoon alles weer weten.
...
Er wordt verwacht dat jij waarde hecht aan het leven van jouw karakter en respecteert deze zoals in het echt.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Indien je in je benen bent geschoten en de andere partij binnen shouting range staat, mag je niet je wapen trekken tenzij persoon/personen volledig overmeesterd zijn door jouw collega’s.
        * Het is niet NVOL wanneer iemand een wapen op jou richt als je al aan het rijden bent, mits je 30 km/u of zachter rijdt.
    * Op de tegenpartij schieten terwijl er iemand in /th vast zit, mag alleen als volgt:
        * Als je iemand met een mes in je hand /th hebt, mag er op je geschoten worden met een categorie wapen hoger.
...
1. Enkele voorbeelden hiervan zijn, maar niet beperkt tot:
    * Het is niet toegestaan om je voertuig als geweldsmiddel te gebruiken. Ook als je iemand niet volledig dood rijdt maar wel aanrijdt telt dit als VDM.
...
1. Enkele voorbeelden hiervan zijn, maar niet beperkt tot:
    * Indien je een voertuig inzet om een zogenoemde pit uit te voeren is dit alleen toegestaan als de snelheid lager is dan 100 km/u en dit op een verantwoorde wijze gaat.
    ...
    * Het is niet toegestaan om een pit uit te voeren op een motor, aangezien de kans op dodelijk letsel te groot is. 
...
2. Een voertuig mag geen hogere categorie pitten of brake check, de volgorde gaat als volgt;
...
Het correct pitten houdt in dat je de andere partij zijn achterkant tikt om hem uit balans te krijgen  en de overhand in het scenario te krijgen. Hierbij hoor je niet onnodig geweld/voertuig gebruik toe te passen. Een stafflid behoudt zijn recht om te bepalen wat wel en niet door de beugel kan.
...
1. Enkele voorbeelden die niet mogen, maar niet beperkt tot:
    ...
    * Het uitschelden van staffleden of beledigen buiten of ingame.
    * Het continu lastigvallen van een bepaalde groep/individu zonder roleplay doeleinde.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Je mag enkel op bandjes van de personen schieten, indien die persoon in de desbetreffende auto/motor een wapen heeft.
    * Als iemand je duidelijk 1 minuut achter je aan zit, dan mogen er banden geschoten worden. Hiervan moet ten alle tijden bewijs aangeleverd worden indien dat gevraagd wordt.
    * Bij lid 3 & 4 moeten er ten alle tijden beeldmateriaal bewijs aangetoond worden van zowel de gegeven call-out/bewijs.

Bij misbruik van een wapen, dan kan deze ingenomen worden door een stafflid.

Deze regel is bedoeld om mensen te beschermen die niet betrokken zijn bij jouw scenario en om te voorkomen dat er zomaar wordt geschoten of gestoken. Wapens dienen als middel om een roleplay scenario te starten, versterken of ondersteunen. Wanneer wapens voor andere doeleinden worden gebruikt, kan dit artikel worden toegepast. Gebruik wapens dus op een respectvolle en verantwoordelijke manier.

### Artikel 5.3: Rippen
Het rippen heeft een paar regels waar je je aan moet houden.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Het is enkel toegestaan spullen uit iemands auto te pakken, indien je een wapen op persoon richt. Het meenemen van dat voertuig voor overladen en /leensleutel vragen is toegestaan.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Het scammen van nieuwe mensen is niet toegestaan.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Het is niet toegestaan om binnen 10 minuten uit de stad te gaan nadat je:
        * Een criminele activiteit hebt gedaan zoals de volgende voorbeelden: 
        * Het overvallen/gijzelen/rippen van mensen.
...
Het doen van criminele activiteiten heeft ook wat regels.

1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    * Indien je een wapen hebt gebruikt mag je pas na 10 minuten, nadat je veilig bent en de andere personen hebt afgeschud stashen.
    * Indien je bent beschoten mag je pas na 10 minuten, nadat je veilig bent en de andere personen hebt afgeschud, stashen.
    * Het stashen van buit van een overval mag je pas na 10 minuten, nadat je veilig bent en de andere personen hebt afgeschud, stashen.
    * Het is niet toegestaan om binnen 2 minuten na een verkoop / witwas actie de buit te stashen zodat anderen dit niet meer kunnen rippen.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    * Tijdens een onderhandeling worden er eisen gesteld, de politie dient zich ten aller tijden aan deze eisen te houden zodra zij akkoord hebben gegeven. Wanneer er vanuit de overvallers een regel of tegeneis verbroken wordt, mag de politie de overvallers hun eisen laten vallen en zal de politie ook harder op mogen treden.
    * Het is verboden om als third-party te mengen in een achtervolging of scenario (bank/gijzeling/winkeltje) als de politie aanwezig is.
        ...
        * Enigste uitzondering met een achtervolging is een helikopter.
...
1. Witwassen | Redzone
    ...
    * Een red-zone houdt in dat er criminele activiteiten plaatsvinden, dit is dus geen locatie om iedereen neer te schieten. Hier mag overvallen worden en wanneer nodig een shootout gestart worden, zonder overtollig geweld.
...
3. Drugsverwerk
    * Het campen of opwachten op/of rondom deze locatie, binnen een straal van 100m is verboden.
    * Hier zal je maar eens per uur mogen komen om te rippen. Dit geldt voor je gehele groep.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Je mag tijdens een mogelijke achtervolging van een verkoper geen banden schieten, tenzij degene zichtbaar een wapen draagt.
    * Een gijzelaar mag geen kennis of vriend van je zijn, maar moet een random persoon zijn.
    * mag de wapens pas “vernietigen” 10 minuten na het verlaten van de locatie en ze worden niet meer gevolgd. De Crimineel moet voordat de Politie op HB komt wel kenbaar maken dat er een achtervolging bezig is, zodat ze niet per ongeluk komen omdat ze je niet hebben gezien HB in gaan.
...
1. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Het verduisteren van items of geld als politie. Zeer gevoelige informatie doorspelen naar onderwereld spelers, denk hierbij aan;
...
Er is wel meer wat onder corruptie valt; laten we het erop houden dat alles wat jouw diensten zijn niet mag gebruikt worden om jouw vrienden te helpen in de onderwereld. Wordt dit gezien? is dit op staande voet ontslag en een opvolgende sanctie.
...
1. Enkele voorbeelden van het misbruik van je microfoon zijn:
    ...
    * Het gebruik maken van irritante voice changers.
...
1. Enkele voorbeelden van Staff abuse, maar niet beperkt tot:
    ...
    * Je permissies gebruiken om er voordeel uit te halen. (Bijvoorbeeld: auto repair, wapens en/of geld in spawnen. etc.)
